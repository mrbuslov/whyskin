# Generated by Django 3.2.10 on 2022-08-31 11:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carted', models.ManyToManyField(blank=True, default=None, related_name='carted', to='cosmetics.Product', verbose_name='Товары в корзине')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('liked', models.ManyToManyField(blank=True, default=None, related_name='liked', to='cosmetics.Product', verbose_name='Понравившиеся товары')),
